...
export const selectIsFavorite = (cardId: string): MemoizedSelector<AppState, boolean> =>
...
export const selectIsFavoriteObservable = (cardId: string, state$: Observable<AppState>): Observable<boolean> =>
